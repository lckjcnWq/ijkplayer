...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-yasm --enable-openssl --enable-libx264 --enable-encoder=libx264 --enable-gpl --enable-libx264 --enable-decoder=h264 --enable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --enable-decoders --enable-encoder=png --enable-encoder=libx264 --enable-encoder=mjpeg --enable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=mjpeg --disable-hwaccels --disable-muxers --enable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --enable-demuxer=mjpeg --enable-demuxer=rtsp --enable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --enable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --enable-protocol=file --enable-protocol=rtsp --enable-protocol=tcp --enable-protocol=hls --enable-protocol=http --enable-protocol=https --enable-openssl --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mjpeg --enable-demuxer=mov --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --disable-bsf=eac3_core --prefix=/home/wquan/ijkplayer/android/contrib/build/ffmpeg-arm64/output --cross-prefix=aarch64-linux-android- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/wquan/ijkplayer/android/contrib/build/openssl-arm64/output/include -I/home/wquan/ijkplayer/android/contrib/build/x264-arm64/output/include ' --extra-ldflags=' -L/home/wquan/ijkplayer/android/contrib/build/openssl-arm64/output/lib -lssl -lcrypto -L/home/wquan/ijkplayer/android/contrib/build/x264-arm64/output/lib -lx264 '"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/home/wquan/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/wquan/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
